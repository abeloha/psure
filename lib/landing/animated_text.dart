...
class AnimatedText extends StatefulWidget {
  ...
  @override
  createState() => new AnimatedTextState(text);
}
...
class AnimatedTextState extends State<AnimatedText>
  ...
  Future startTextAnimation() async {
    animationController = new AnimationController(
        vsync: this,
        value: 0.0,
        lowerBound: 0.0,
        upperBound: textRunes.length.toDouble(),
        duration: new Duration(milliseconds: widget.durationInMilliseconds));
    ...
    await new Future.delayed(
        new Duration(milliseconds: widget.delayInMilliseconds));
